...
API_KEY = "sk-nxvyrqxdmlclzuymuaehxteplvhsyvhvbkhucdfwffonjuzr"
...
def main():
    ...
    for i, req in enumerate(request_records, start=1):
        cid = req["cluster_id"]
        print("-" * 80)
        print(f"[{i}/{len(request_records)}] 正在审查簇：{cid}")
